...
class DOTAMetric(BaseMetric):
    ...
    def merge_results(self, results: Sequence[dict],
                      outfile_prefix: str, DOTA_DEVKIT_FORMAT=True) -> str:
        ...
        """
        if DOTA_DEVKIT_FORMAT:
            print("[Warning] Using the dota_devkit format to merge results...")
        ...
        for idx, result in enumerate(results):
            ...
            if DOTA_DEVKIT_FORMAT:
                ori_bboxes[..., :4] = ori_bboxes[..., :4] / ratio
